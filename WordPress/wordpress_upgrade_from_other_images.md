...
This document describes the approach to upgrade WordPress instances running on Linux App Service with other images to the new [WordPress image](https://mcr.microsoft.com/appsvc/wordpress-alpine-php).
...
4. Update the new image details in the deployment centre with appropriate **tag** value and restart your App. 
<br>
